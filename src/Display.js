...
const API_KEY = new NewsAPI('03bcfb11eafb4ab2a9a787551ee1e86d');
...
class Display extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps !== this.props) {
      this.setState({ url: `https://newsapi.org/v2/top-headlines?sources=${nextProps.default}&apiKey=03bcfb11eafb4ab2a9a787551ee1e86d ` });
  ...
  getArticles(url) {
    const apiKey = '03bcfb11eafb4ab2a9a787551ee1e86d';
